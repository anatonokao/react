...
exports.response = exports.book = void 0;
exports.book = {
    kind: 'books#volume',
    id: 'EaD1kIfiTfoC',
    etag: 'BXHkOdp49S0',
    ...
    volumeInfo: {
        ...
        pageCount: 896,
        imageLinks: {
            smallThumbnail: 'http://books.google.com/books/content?id=EaD1kIfiTfoC&printsec=frontcover&img=1&zoom=5&edge=curl&imgtk=AFLRE70uKpYK_BhLLT2la66ucQEjev7obEbQr39dKMrjWwRook3tMCYWcPBTMhccT_G3sZmyig243_HkwC-b7kww9gjZFED9YgLOeVtw0yE_4MOCrZbPjeojBJyeSoxuBGCA3fwYT2CY&source=gbs_api',
            thumbnail: 'http://books.google.com/books/content?id=EaD1kIfiTfoC&printsec=frontcover&img=1&zoom=1&edge=curl&imgtk=AFLRE73Ug1-aM11zmm8yfnoh7FYCW6Bw4qIb8nJmMM1uFMB-UiowNOAz6vsPNhg2Ykv_62yeShiJ9SsiWcdGswlD6Qavl7Tri_tbP2PfTKeuGtvWcvKpq0h2vS05-ickWtz8tYYs620y&source=gbs_api',
        },
        language: 'en',
    },
    saleInfo: {
        ...
        buyLink: 'https://play.google.com/store/books/details?id=EaD1kIfiTfoC&rdid=book-EaD1kIfiTfoC&rdot=1&source=gbs_api',
    },
};
exports.response = {
    kind: 'books#volumes',
